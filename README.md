...
1. A ***centaur*** (human-assisted-by-machine): a person who uses technology as a tool that augments their abilities.
2. A ***reverse-centaur*** (machine-assisted-by-human): a machine that uses a human as its subordinate component. In this case, the human becomes a reactive appendage serving the machine’s demands rather than the other way around
...
I want the agent to actually have *less agency*.
